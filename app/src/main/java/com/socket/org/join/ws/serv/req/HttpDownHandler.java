...
//        String temp = "http://10.10.30.235:8080/sdcard";   ///添加referer实现浏览器链接直接下载文件
...
//
//    public void setStartDownloadCallback(StartDownloadListener callback){
...
//     *下载完成通知回调socket
//     */
//    private DownloadResultListener downloadSuccess;
//
//    public void setDownloadSuccessCallback(DownloadResultListener callback){
